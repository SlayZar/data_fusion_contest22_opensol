...
def main():
    ...
    clickstream = read_cl_data(input_folder=data)
    ...
    # Read data and label encoder to decrease used RAM
    transactions = read_tr_data(input_folder=data)
    # New feats basing on hour embeddings
